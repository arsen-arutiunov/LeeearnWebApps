...
class GroupMethods(BaseMethods):
    ...
    async def CreateGroupComment(self, branch_id: SafeUUID | str, group_id: SafeUUID | str, content: str):
        """
        Endpoint: /CompanyBranchGroup/CreateGroupComment
        ...
        """
        return await self.client.send_request(
            f"{self.path}/CreateGroupComment",
            {
                "companyBranchId": str(branch_id),
                "data": {"content": content},
                "groupId": str(group_id)
...
class BoundGroupMethods:
    ...
    async def CreateGroupComment(self, group_id: SafeUUID | str, content: str):
        return await self.methods.CreateGroupComment(self.branch_id, group_id, content)
